...
# TODO: Rewrite this as you read it.
# Original code based on Aurelian Geron's handson-ml example.

### Capsule Networks (CapsNets)

# Based on the paper: [Dynamic Routing Between Capsules](https://arxiv.org/abs/1710.09829),
# by Sara Sabour, Nicholas Frosst and Geoffrey E. Hinton (NIPS 2017).

# Inspired in part from Huadong Liao's implementation:
...
# TODO: Make this work with the 'MNIST original' from sklearn
